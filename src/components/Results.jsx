    ...
    return (
        <div className="flex flex-col">
            <div className="flex mb-1">
                ...
                <div className="w-11/12 flex justify-around flex-wrap">
                    {props.rows.map((data, index) => {
                        return (
                            <div className="w-1/12 break-words p-2 m-1 bg-purple-400 rounded-sm" key={index}>
            ...
            <div className="flex mb-1">
                ...
                <div className="w-11/12 flex justify-around flex-wrap">
                    {placeHolderMapping.map((data, index) => {
                        return (
                            <div className="w-1/12 break-words flex-wrap p-2 m-1 bg-blue-300 rounded-sm" key={index}>
                                <span className="break-words">{data}</span>
                            </div>
                        );
                    })}
                        ...
                        return (
                            <div className="flex justify-around flex-wrap" key={index}>
                                {data.map((row_data, idx) => {
                                    return (
                                        <div className="w-1/12 p-2 m-1 bg-blue-50 text-blue-800 rounded-sm   " key={idx}>
